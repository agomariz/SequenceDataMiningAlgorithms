package agp.spmf.algorithms.sequentialpatterns.clasp_AGP.dataStructures.abstracciones;
...
public class ItemAbstractionPair implements Comparable<ItemAbstractionPair> {
    ...
    /**
     * Get the string representation of this object for saving to file. Adjusted to SPMF format.
    ...
    public int compareTo(ItemAbstractionPair o) {
        int itemComparison = getItem().compareTo(o.getItem());
        if (itemComparison == 0) {
